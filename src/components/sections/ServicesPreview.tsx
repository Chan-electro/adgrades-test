                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {servicesData.services.map((service, index) => (
                        <motion.div
                            ...
                            className="group p-10 rounded-3xl border border-gray-100 hover:border-blue-primary/30 bg-white hover:shadow-2xl hover:shadow-blue-primary/5 transition-all duration-300 relative overflow-hidden flex flex-col items-start"
                        >
